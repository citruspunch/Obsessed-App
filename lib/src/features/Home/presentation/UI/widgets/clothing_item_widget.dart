      ...
      child: ClipRRect(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(top: 13.0, left: 18.0, right: 18.0, bottom: 7.0),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Row(
              ...
              Padding(
                padding: const EdgeInsets.only(right: 18.0, left: 15.0, bottom: 12.0, top: 7.0),
                child: Wrap(
                  children: [
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            if (isFavoriteItem)
                              Text(' (${item.rating['count']})', style: GoogleFonts.poppins(fontSize: subtitleFontSize - 0.5, color: Colors.grey[600])),
